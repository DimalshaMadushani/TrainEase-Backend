...
const seedUttaraStops = async () => {
  ...
  console.log("Uttara devi stops Seeding complete!");
} catch (error) {
  console.error("Error populating stops Uttara:", error);
}
}

export default seedUttaraStops;
